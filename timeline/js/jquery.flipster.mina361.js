  ...
  $.fn.flipster = function (options) {
    ...
    return this.each(function () {
      ...
      function updateNav() {
        ...
        /*--- My custom for my own project ---*/

        var currentNav = '#'+_currentItem.data('flip-nav');
        jQuery('.update-timeline li a').removeClass('active');
        jQuery(currentNav).find('>a').addClass('active');
